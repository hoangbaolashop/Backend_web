...
const createOrder = async (req, res) => {
    try {
            ...
            const mailOptions = {
                ...
                html: `
                    <div style="max-width: 600px; margin: 0 auto; font-family: Arial, sans-serif; background-color: #f9f9f9; padding: 20px; border-radius: 10px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                        ...
                        <p style="text-align: center; font-size: 16px;">Admin có thể quản lý đơn hàng tại <a href="https://admingame.tigarboardgame.com/admin" style="color: #3498db; text-decoration: none;">Trang Quản Lý</a></p>
                    </div>
                `
            };
        ...
        // Gửi email thông báo đơn hàng mới đến Admin
        const emailAdmin = 'tigarbg98@gmail.com'
